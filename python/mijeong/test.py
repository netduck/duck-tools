...
from binascii import a2b_hex, a2b_qp, unhexlify
...
decrypter = Decrypter()
TK = unhexlify('b765cd4e68c009555a2ed173ee2a653f')
pkt = rdpcap('./test/sa_request.pcap')[0]
decrypter.unwpa2(pkt, TK)