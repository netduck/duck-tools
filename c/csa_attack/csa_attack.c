...
int csaATK(const unsigned char *Interface, const unsigned char *Input_AP_MAC, const unsigned char *Input_STA_MAC, const unsigned char *Input_AP_Ch);
...
int main(int argc, char *argv[])
{
    ...
    csaATK(Interface, Input_AP_MAC, Input_STA_MAC, Input_AP_Ch);
}
